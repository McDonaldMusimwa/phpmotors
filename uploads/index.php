...
// Build a navigation bar using the $classifications array the createNavList is in the functions folder
$navList = createNavList($classifications);

// get the actions variable that will filter the input that will be stored in the actions variable
